...
exports.getRoles = exports.Faction = exports.Role = exports.init = void 0;
function init() {
...
exports.init = init;
var townCondition = "You win when all anti-town players are dead.";
var mafiaCondition = "You win when all other factions are dead.";
var werewolfCondition = "You win when all other factions are dead.";
var alienCondition = "You win when all other factions are dead.";
var cultCondition = "You win when all living players are cultists.";
// Role structures
var Role = /** @class */ (function () {
    function Role(title, description, condition, faction) {
        this.title = title;
